...
<img src="./slides_practice_01_files/anaconda_servey-01.png" width="110%" align = "center">
...
<img src="./slides_practice_01_files/anaconda_servey-02_short.png" width="100%" align = "center">
...
- Репозиторий со скриптами и pdf-файлами к лекциям и лабораторным: 
...
`r icons::fontawesome("check-square")` графические результаты выводятся во встроенный просмотрщик, либо в файл    
